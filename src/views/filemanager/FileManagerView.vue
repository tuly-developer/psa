              ...
              >
                <h5 style="margin-bottom: 1rem">
                  ...
                  <span
                    ...
                    class="float-right mdi mdi-close"
                    style="color: gray; font-size: 22px; cursor: pointer"
                  ></span>
                </h5>
              </div>
          ...
          <thead>
            <tr>
              ...
              >
                Fecha
                <span
                  v-if="orderByMethod === 'desc'"
                  @click="changeOrderByMethod('asc')"
                  class="mdi mdi-arrow-up-thick text-dark"
                  style="cursor: pointer"
                ></span>
                <span
                  v-else
                  @click="changeOrderByMethod('desc')"
                  class="mdi mdi-arrow-down-thick text-dark"
                  style="cursor: pointer"
                ></span>
              </th>
          ...
          <tbody>
            <tr v-for="data in tableData" :key="data.id">
              <td>
                ...
                >
                  {{
                    data.type == 1 ? "XLS" : data.type == 2 ? "XLS" : "Tar.gz"
                  }}
                </button>
              </td>
          ...
          >
            ...
            >
              ...
              >
                ...
                <defs>
                  <pattern
                    id="pattern0_4065_7886"
                    patternContentUnits="objectBoundingBox"
                    width="1"
                    height="1"
                  >
                    <use
                      xlink:href="#image0_4065_7886"
              ...
              <small>
                <p>
                  ...
                  <br />
                  Solo archivos {{ fileTypes[sectionSelected].toUpperCase() }}
                </p>
            ...
            <div class="upload-modal-button-container">
              ...
              <button type="submit" style="background-color: #0078d4">
                Importar
              </button>
            </div>
