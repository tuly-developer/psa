    ...
    <nav class="mt-4">
      ...
      >
        <nav-item-component
          ...
          link="/main"
          >Inicio</nav-item-component
        >
        <nav-item-component
          class="ml-1"
          icon="mdi mdi-file-outline"
          link="/main/filemanager"
          >Gestión de Archivos</nav-item-component
        >
        <nav-item-component class="ml-1" icon="mdi mdi-radar" link="/main"
          >Informes</nav-item-component
        >
        <nav-item-component class="ml-1" icon="fas fa-list" link="/main"
          >Listado de tramites</nav-item-component
        >
